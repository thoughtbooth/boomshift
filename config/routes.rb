Rails.application.routes.draw do
  ...
  resources :businesses, :clients, :services, :enrollments, :jobs, :job_statuses, :invoices, :invoicing_line_items # remove invoicing_line_items from routes after development is complete.
  devise_for :users
